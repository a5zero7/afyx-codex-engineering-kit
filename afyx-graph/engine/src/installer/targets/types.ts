 ...
 *
 * `alreadyConfigured` reports whether afyx-graph has already been
...
export interface InstallOptions {
   ...
   * afyx_graph_explore context for structural prompts. `true` installs it,
...
export interface AgentTarget {
   ...
   * target. Used by `afyx-graph install --print-config <id>` and by
