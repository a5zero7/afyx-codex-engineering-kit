 ...
 *
 * Detection:
 *   - `AFYX_GRAPH_ASCII=1`  -> ASCII (escape hatch for any terminal)
 *   - `AFYX_GRAPH_UNICODE=1` -> Unicode (opt-in on any terminal)
 ...
 * Windows terminal unless the user opts in via AFYX_GRAPH_UNICODE=1 —
