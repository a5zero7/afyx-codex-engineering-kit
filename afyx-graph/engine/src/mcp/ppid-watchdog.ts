...
export interface SupervisionState {
   ...
   * (`AFYX_GRAPH_HOST_PPID`), or null when unknown — e.g. the standalone bundle,
 ...
 * (`AFYX_GRAPH_PPID_POLL_MS`). A value of `0` disables the watchdog entirely
 ...
 * (`AFYX_GRAPH_HOST_PPID`). Returns a positive integer PID, or null when
