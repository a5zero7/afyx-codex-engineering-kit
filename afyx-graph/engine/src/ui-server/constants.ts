/**
 * User-facing constants for the `afyx-graph ui` server.
 *
...
/** The port `afyx-graph ui` asks for first. */
...
/**
 * Overrides which browser (if any) `afyx-graph ui` launches. `none` — or `0`,
 ...
 * single argument.
 */
export const BROWSER_ENV = 'AFYX_GRAPH_BROWSER';
 ...
 * shipped build.
 */
export const VIEWER_PATH_ENV = 'AFYX_GRAPH_VIEWER_PATH';
