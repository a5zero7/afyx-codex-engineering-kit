...
export class TreeSitterExtractor {
  ...
  // Value-reference edges (default ON; set AFYX_GRAPH_VALUE_REFS=0 to disable; see flushValueRefs).
  ...
  private readonly valueRefsEnabled = process.env.AFYX_GRAPH_VALUE_REFS !== '0';
   ...
   * function_ref), deduped per (reader, target). Default on (AFYX_GRAPH_VALUE_REFS=0 disables) +
   ...
   * `afyx-graph query query_apply_record` returned nothing (issue #634). We emit
