...
Use direct file reads or targeted text search for known symbols, simple textual facts, configuration, and localized changes.

Use CodeGraph when relationships materially determine correctness: callers, references, inheritance, dependency paths, dynamic dispatch, or cross-module impact. Do not use it merely because it is available.
