...
version: 1.0.0
description: Version-aware Odoo engineering for Odoo 10 through 20. Activates only for Odoo repositories, modules, ORM, views, reports, security, migrations, or Odoo debugging.
---
...
2. Identify one target version from 10 through 20.
